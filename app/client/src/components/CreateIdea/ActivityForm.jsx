        ...
        <Paper shadow="none" p="sm">
            <SimpleGrid cols={{ base: 1, sm: 3 }}>
                <TimeInput
                    ...
                    onChange={(e) => handleChangeActivity('start', idx, e.target.value)}
                    placeholder="Time"
                    required
                />
                <TimeInput
                ...
                <TextInput
                    ...
                    value={activity.name}
                    onChange={(e) => handleChangeActivity('name', idx, e.target.value)}
                    required
                />
            </SimpleGrid>
            ...
            <Textarea
                ...
                onChange={(e) => handleChangeActivity('description', idx, e.target.value)}
                autosize
                maxRows={3}
                required
            />
            ...
            <Grid align="end">
                <Grid.Col span={6}>
                    <NumberInput
                        ...
                        onChange={(value) => handleChangeActivity('budget', idx, value)}
                        prefix="$"
                    />
                </Grid.Col>
                <Grid.Col span={3}>
